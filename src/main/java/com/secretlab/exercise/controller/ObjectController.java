...
public class ObjectController {
  ...
  /**
   * POST /object Body: { "mykey": <any JSON value> }
   *
   * <p>Validation and k:v extraction are delegated to {@link #checkAndBuildStoreRequest}. JSON
   * conversion is handled by {@link JsonUtils}.
   */
  @PostMapping
  ...
  /**
   * Validates the raw POST body and builds a {@link StoreRequest}. {@link
   * jakarta.validation.ConstraintViolationException} handled by GlobalExceptionHandler.
   */
  ...
  /**
   * GET /object/get_all_records Returns the latest version of every key as a compact list.
